...
def initialize_component(component_name, useOnline=True, processor="local"):
    ...
    if component_name == "vision":
        success = core.initialize_vision(processor)
    elif component_name == "voice":
        success = core.initialize_voice(useOnline)
    elif component_name == "nlp":
        success = core.initialize_nlp()
    elif component_name == "control":
        success = core.initialize_control()
